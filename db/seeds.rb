...
ToneResponse.create(primary_tone: "anger", primary_score: 0.57, journal_entry: entry_2, created_at: current_date - 1.days)
...
ToneResponse.create(primary_tone: "sadness", primary_score: 0.57, journal_entry: entry_3, created_at: current_date - 2.days)
...
ToneResponse.create(primary_tone: "tentative", primary_score: 0.67, journal_entry: entry_4, created_at: current_date - 3.days)
...
ToneResponse.create(primary_tone: "joy", primary_score: 0.79, journal_entry: entry_5, created_at: current_date - 4.days)
...
ToneResponse.create(primary_tone: "confident", primary_score: 0.79, journal_entry: entry_6, created_at: current_date - 5.days)
...
ToneResponse.create(primary_tone: "analytical", primary_score: 0.69, journal_entry: entry_7, created_at: current_date - 6.days)
